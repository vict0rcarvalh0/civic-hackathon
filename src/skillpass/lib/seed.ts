...
const sampleSkills = [
  ...
  },
  {
    ...
    tokenId: '2',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '3500000000000000000',
    endorsementCount: 12,
    verified: true,
    status: 'verified'
  },
  {
    ...
    tokenId: '3',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '4200000000000000000',
    endorsementCount: 10,
    verified: true,
    status: 'verified'
  },
  ...
  // Mike Johnson's skills
  {
    ...
    tokenId: '4',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '6000000000000000000',
    endorsementCount: 18,
    verified: true,
    status: 'verified'
  },
  {
    ...
    tokenId: '5',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '4800000000000000000',
    endorsementCount: 15,
    verified: true,
    status: 'verified'
  },
  ...
  // Emma Wilson's skills
  {
    ...
    tokenId: '6',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '5500000000000000000',
    endorsementCount: 14,
    verified: true,
    status: 'verified'
  },
  {
    ...
    tokenId: '7',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '3200000000000000000',
    endorsementCount: 11,
    verified: true,
    status: 'verified'
  },
  ...
  // David Kim's skills
  {
    ...
    tokenId: '8',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '4000000000000000000',
    endorsementCount: 13,
    verified: true,
    status: 'verified'
  },
  {
    ...
    tokenId: '9',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '5200000000000000000',
    endorsementCount: 16,
    verified: true,
    status: 'verified'
  },
  ...
  // Lisa Rodriguez's skills
  {
    ...
    tokenId: '10',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '4500000000000000000',
    endorsementCount: 12,
    verified: true,
    status: 'verified'
  },
  ...
  // Alex Thompson's skills
  {
    ...
    tokenId: '11',
    contractAddress: '0xSkillNFTContract',
    totalStaked: '7000000000000000000',
    endorsementCount: 9,
    verified: true,
    status: 'verified'
  }
...
export async function seedDatabase() {
  try {
    ...
    endorsementData.push({
      ...
      stakedAmount: '800000000000000000',
    ...
    endorsementData.push({
      ...
      stakedAmount: '1200000000000000000',
    ...
    for (let i = 0; i < 20; i++) {
      ...
      if (randomSkill.userId !== randomEndorser.id) {
        endorsementData.push({
          ...
          stakedAmount: (Math.random() * 2000000000000000000 + 500000000000000000).toString(),
